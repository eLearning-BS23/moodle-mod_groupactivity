...
$string['activityselector'] = 'Group activity selector';
...
$string['groupactivity:addinstance'] = 'Add a new groupactivity';
$string['groupactivity:view'] = 'View groupactivity';
$string['groupactivitytext'] = 'Groupactivity text';
$string['modulename'] = 'Groupactivity';
$string['modulename_help'] = 'The groupactivity module enables text and multimedia to be inserted into the course page in between links to other resources and activities. Groupactivity are very versatile and can help to improve the appearance of a course if used thoughtfully.

Groupactivity may be used
...
$string['modulename_link'] = 'mod/groupactivity/view';
$string['modulenameplural'] = 'Group activities';
$string['privacy:metadata'] = 'The Group activity resource plugin does not store any personal data.';
$string['pluginadministration'] = 'Group activity administration';
$string['pluginname'] = 'Group activity';
$string['search:activity'] = 'Group activity';
